...
contract LinuxEduToken is Ownable, ERC20Burnable {
    constructor(uint256 initialSupply) ERC20("LinuxEDU", "LNX") Ownable(msg.sender) {
    ...
    function transferToken(address _toAddress, uint _amount) public {
        bool sucess = transfer(_toAddress, _amount);
        assert(sucess);
    }
}
